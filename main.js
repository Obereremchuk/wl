...
$(document).ready(function () {
	...
	$("#create_btn_CP").click( createNotification_CP ); // bind action to button click
        $("#create_btn_CMM").click( createNotification_CMM );
        $("#create_btn_CMM").click( createNotification_CMA );
